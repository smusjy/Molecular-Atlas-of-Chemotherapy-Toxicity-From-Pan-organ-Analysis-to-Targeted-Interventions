...
# 设置工作目录
setwd("E:/9. Chemo_AEs_altas/Analysis/Results/Figure 4/count_comparison_limma_pandrug/log2FC")
...
# 保存无标签版本图片
ggsave("organ_specific_expression_zscores_no_labels.pdf", width = 12, height = 3.5, dpi = 300)
