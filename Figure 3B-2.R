...
library(aplot)
library(ape)    # 添加这一行
library(reshape2)  # 也添加这个包，因为代码中用到了reshape2::dcast

# 设置工作目录
setwd("E:/9. Chemo_AEs_altas/Analysis/Results/Figure 3/Results/Pandrug")
...
# 创建器官名称转换向量
organ_names <- c(
  "Blood_drug_vs_PBS_cibersort_limma_results.csv" = "Blood",
  "gan_drug_vs_PBS_cibersort_limma_results.csv" = "Liver",
  "gao_drug_vs_PBS_cibersort_limma_results.csv" = "Testis",
  "gu_drug_vs_PBS_cibersort_limma_results.csv" = "Bone",
  "guan_drug_vs_PBS_cibersort_limma_results.csv" = "Blood Vessel",
  "ji_drug_vs_PBS_cibersort_limma_results.csv" = "Skeletal Muscle",
  "jie_drug_vs_PBS_cibersort_limma_results.csv" = "Colon",
  "Lung_drug_vs_PBS_cibersort_limma_results.csv" = "Lung",
  "nao_drug_vs_PBS_cibersort_limma_results.csv" = "Brain",
  "pi_drug_vs_PBS_cibersort_limma_results.csv" = "Skin",
  "qian_drug_vs_PBS_cibersort_limma_results.csv" = "Prostate",
  "shen_drug_vs_PBS_cibersort_limma_results.csv" = "Kidney",
  "wei_drug_vs_PBS_cibersort_limma_results.csv" = "Stomach",
  "xin_drug_vs_PBS_cibersort_limma_results.csv" = "Heart"
)

# 转换器官名称
final_data$organ <- organ_names[final_data$organ]
