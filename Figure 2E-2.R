...
# 设置工作目录
setwd("E:/9. Chemo_AEs_altas/Analysis/Results/Figure 2/Figure 2E/log2FC")
...
# 新的基因排序方法，基于每个器官的top基因按z-score排序
gene_order <- c()
# 从下往上遍历器官（使用rev确保器官顺序从上往下显示）
...
# 保存无标签版本图片
ggsave("organ_specific_expression_zscores_no_labels.pdf", width = 12, height = 3.33, dpi = 300)
