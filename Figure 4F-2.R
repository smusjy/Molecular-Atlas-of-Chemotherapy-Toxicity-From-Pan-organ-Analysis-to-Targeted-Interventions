...
# 设置工作目录
setwd("E:/9. Chemo_AEs_altas/Analysis/Results/Figure 4/ssGSEA/ssgsea_comparison_limma_pandrug/log2FC")
...
# 读取选定的通路列表
selected_pathways <- read_excel("cell_pandrug_pathway.xlsx")
...
# 读取通路名映射文件
pathway_mapping <- read_excel("cell_pandrug_pathway_2.xlsx")
...
# 保存带X轴标签版本
ggsave("selected_pathway_zscores_with_x_labels.pdf", p_with_x_labels, width = 10, height = 3.8, dpi = 300)
